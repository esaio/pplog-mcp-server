...
describe("createPplogClient", () => {
  ...
  it("should create client with correct baseUrl", () => {
    ...
    createPplogClient(config.apiAccessToken, config.apiBaseUrl, noopLogger);
  ...
  it("should return the configured client", () => {
    ...
    const result = createPplogClient(
  ...
  it("should create separate client instances for different tokens", () => {
    ...
    createPplogClient(token1, config.apiBaseUrl, noopLogger);
    createPplogClient(token2, config.apiBaseUrl, noopLogger);
  ...
  it("should create separate client instances for different base URLs", () => {
    ...
    createPplogClient(config.apiAccessToken, url1, noopLogger);
    createPplogClient(config.apiAccessToken, url2, noopLogger);
